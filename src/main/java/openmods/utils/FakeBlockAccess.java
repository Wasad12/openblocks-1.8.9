...
// 1.8.9 port of OpenModsLib FakeBlockAccess: single-state stub world for GUI
// previews. 1.8.9 adaptations: getBiomeGenForCoords/BiomeGenBase (no Biome
// registry in 1.8.9), BlockPos/EnumFacing imports. Logic verbatim.
