...
import net.minecraft.util.EnumFacing;import net.minecraft.util.IChatComponent;
import openmods.utils.bitmap.IReadableBitMap;

// 1.8.9 port of OpenModsLib SidedInventoryAdapter: same side-gating logic.
// 1.8.9 adaptations: isUseableByPlayer spelling, IChatComponent display name, no
// isEmpty (added in later versions). The original's clear() quirk (calls
// getFieldCount instead of clearing) is preserved verbatim — same behavior.
