...
// 1.8.9 port of OpenModsLib SidedItemHandlerAdapter: same per-side handler logic.
// 1.8.9 adaptations: nullable stacks (no ItemStack.EMPTY), no getSlotLimit (added in
// later versions — 1.8.9 IItemHandler has getSlots/getStackInSlot/insertItem/
// extractItem only).
