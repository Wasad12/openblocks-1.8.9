...
// Imports adjusted (1.8.9: readVarIntFromBuffer/writeVarIntToBuffer); logic verbatim.
public abstract class SyncRpcTarget implements IRpcTarget {
	...
	// NOTE: SyncEntityRpcTarget (entity sync/RPC path) dropped per §19 — no ported
	// feature uses entity sync maps.
}
