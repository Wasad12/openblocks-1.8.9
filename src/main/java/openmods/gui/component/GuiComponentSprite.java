...
// 1.8.9 port of 1.12.2 GuiComponentSprite: verbatim (Icon.createSheetIcon,
// BaseComponent.drawSprite and TextureAtlasSprite.getIconWidth/getIconHeight all
// exist in 1.8.9). Needed by GuiAutoAnvil (hammer + plus icons).
