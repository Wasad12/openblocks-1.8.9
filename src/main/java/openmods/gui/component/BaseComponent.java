...
public abstract class BaseComponent extends Gui {
	...
	// NOTE: asset copied verbatim from OpenModsLib (assets/openmods/textures/gui/
	// components.png); only the domain is repointed to openblocks (same convention
	// as all other copied 1.12.2 assets).
	public final static ResourceLocation WIDGETS = new ResourceLocation("openblocks", "textures/gui/components.png");
