...
public class TileEntityTank extends TileEntity implements ITickable, IFluidHandler {
	...
	protected ItemStack tryEmptyItem(EntityPlayer player, ItemStack container) {
		...
		// DELIBERATE (user request 2026-09-12): no fill sound at all. Vanilla 1.8.9
		// buckets only fizz for lava (ItemBucket bytecode verified); the user wants
		// silence for every fluid including lava.
