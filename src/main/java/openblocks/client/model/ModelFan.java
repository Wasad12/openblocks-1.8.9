...
// Verbatim from OpenBlocks 1.8.X (user-authorized exception to the no-1.8-branches
// rule, fan only, 2026-09-13): Techne-style head model — 8 ring struts + stand +
// base + 10x10 blade quad. UV-mapped onto textures/models/fan.png (32x32).
