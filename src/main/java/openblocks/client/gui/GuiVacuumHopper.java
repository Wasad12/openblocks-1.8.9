...
// 1.8.9 port of 1.12.2 GuiVacuumHopper: verbatim (tank gauge in raw mB — no
// levels conversion, unlike the anvil/enchant gauges — plus item/xp side tabs).
// Only the block/item field names follow stable_22 lower_snake.
