...
- **Current feature:** Fan — fix loop 2 (particles) built, deployed, UNTESTED.
...
- **Last successful build:** `OpenBlocks-1.8.9-1.0.0.jar` (522,673 bytes, reobfuscated, stable_22) — BUILD SUCCESSFUL 2026-09-13 (Fan fix loop 2: particle-only blockstate/model)
...
- **Next exact action (in order):**
  1. Await user retest of fan break/punch particles.
