...
- **Last successful build:** `OpenBlocks-1.8.9-1.0.0.jar` (523,049 bytes, reobfuscated, stable_22) — BUILD SUCCESSFUL 2026-09-13 (Fan fix loop 5: 1.12.2 default-block TPP)
...
- **Last known-good Git commit:** `d8e4e6d` (Fan fix loop 5; matches
  deployed 523,049-byte JAR).
