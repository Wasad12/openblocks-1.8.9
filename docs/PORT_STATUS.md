...
- **Last successful build:** `OpenBlocks-1.8.9-1.0.0.jar` (153,254 bytes, reobfuscated, stable_22) — BUILD SUCCESSFUL 2026-09-12 (Tank fix loop 2: connectivity + item fluid + sound)
